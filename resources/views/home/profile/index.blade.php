...
<div class="bg-slate-50 min-h-screen pb-24 font-kanit">
    <div class="bg-white border-b border-slate-100 pt-20 pb-12 p-5">
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row items-center gap-8">
                ...
                <div class="md:self-start">
                    <a href="#"
                        class="flex items-center gap-2 px-6 py-3 bg-white border border-slate-200 rounded-2xl font-bold text-slate-600 hover:bg-slate-50 transition-all">
    ...
    <div class="container mx-auto px-6 mt-13 p-7">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            $totalLessons = $allLessons->where('status', 0)->count();
                    ...
                    <div class="flex-1 flex flex-col justify-between py-2">
                        <div>
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <span
                                    class="text-[10px] font-black text-amber-500 bg-amber-50 px-2 py-1 rounded-md">WAITING</span>
                                @endif
                            </div>
                            <p class="text-xs text-slate-400 mb-6 italic">เริ่มเรียนเมื่อ:
                        ...
                        @else
                        <div
                            class="mt-6 py-4 bg-slate-50 text-slate-400 text-center rounded-2xl text-xs font-bold border border-slate-100">
            ...
            <div class="lg:col-span-2 text-center py-20 bg-white rounded-[3rem] border border-dashed border-slate-200">
                ...
                <p class="text-slate-400 mb-8 font-medium text-sm">เริ่มค้นหาบทเรียนที่ใช่ แล้วก้าวไปข้างหน้าพร้อมกับเรา
                </p>
                <a href="{{ route('courses.all') }}"
                    class="px-8 py-4 bg-blue-600 text-white rounded-2xl font-black shadow-xl shadow-blue-200 hover:bg-blue-700 transition-all">
                    ไปที่หน้าคอร์สเรียน
                </a>
            </div>
            @endforelse
...
@if(session('msg_payment'))
<div class="fixed top-0 left-0 right-0 z-50 bg-green-50 border-b border-green-200 p-4">
    <div class="container mx-auto px-6 flex items-center gap-3">
        <i class="fas fa-check-circle text-green-600 text-xl"></i>
        <p class="text-green-800 font-semibold">{{ session('msg_payment') }}</p>
