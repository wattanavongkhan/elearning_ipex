...
<div class="max-w-12xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden p-4">
        <div class="flex justify-between items-center mb-5">
            <div>
                <h3 class="text-xl font-bold text-gray-800">เพิ่มแขกใหม่</h3>
                <p class="text-sm text-gray-500">ข้อมูลแขกใหม่</p>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 gap-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-7">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="members" id="members" value="{{ old('members') }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap5">
                        <div class="md:col-span-2">
                            <label class="block font-bold  mb-2">Hotel <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-7">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="request_booking" id="request_booking"
                                value="{{ old('request_booking') }}" required
                                class="w-full border rounded-lg p-2">
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                class="w-full border rounded-lg p-2"
                                name="category_color" id="category_color">
