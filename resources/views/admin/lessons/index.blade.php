    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden p-5">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
                ...
                <h3 class="text-xl font-bold text-gray-700">บทเรียนของคอร์ส : <span
        ...
        <table class="w-full text-left border-collapse" id="lessons_tb">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-6 py-4">
                        @if($lesson->video_url)
                        <span
                            class="px-2 py-1 text-[10px] bg-red-50 text-red-600 rounded-lg border border-red-100">YouTube</span>
                        @elseif($lesson->video_path)
                        <span
                            class="px-2 py-1 text-[10px] bg-blue-50 text-blue-600 rounded-lg border border-blue-100">Storage</span>
                        @else
                        <span
                            class="px-2 py-1 text-[10px] bg-gray-50 text-gray-400 rounded-lg border border-gray-100">ไม่มีวิดีโอ</span>
                        @endif
                    </td>
