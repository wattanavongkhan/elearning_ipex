...
<div class="max-w-12xl mx-auto">
    <div class="mb-5">
        <nav class="text-sm text-gray-500 mb-1">
            ...
            <span class="text-gray-800 font-medium">แก้ไขบทเรียน</span>
        </nav>
        <h3 class="text-xl font-bold text-gray-700">แก้ไขบทเรียน: <span class="text-blue-600">{{ $lesson->title }}</span></h3>
    </div>
                ...
                <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                    ...
                    <div class="grid grid-cols-1 gap-y-4">
                        ...
                        <div class="relative py-2">
                            ...
                            <div class="relative flex justify-center text-xs uppercase"><span class="bg-slate-50 px-2 text-gray-400 font-bold">หรือเปลี่ยนไฟล์วิดีโอ</span></div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mb-3 flex items-center gap-2 p-3 bg-blue-50 rounded-xl border border-blue-100 w-fit">
                                ...
                                <span class="text-xs text-blue-800 font-medium">ปัจจุบันมีไฟล์วิดีโออัปโหลดไว้แล้ว</span>
                            </div>
                            @endif
