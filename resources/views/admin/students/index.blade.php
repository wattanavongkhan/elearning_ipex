            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm text-gray-600 divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-blue-50/30 transition-colors">
                        ...
                        <td class="p-4">
                             <span class="px-2 py-1 text-xs rounded-full {{ $student->status == '0' ? 
                        ...
                        <td class="p-4">
                            <span class="px-2 py-1 text-xs rounded-full {{ $student->status_activate == '1' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                        ...
                        <td class="p-4 flex items-center justify-center gap-3">
                            <a href="{{ route('students.edit', $student->id) }}" class="bg-yellow-500 text-white hover:bg-yellow-600 rounded-lg p-2"
                                title="แก้ไขนักเรียน">
                            ...
                            <form action="{{ route('students.destroy', $student->id) }}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="bg-red-500 text-white hover:bg-red-600 rounded-lg p-2 transition"
                                    title="ลบนักเรียนนี้">
